...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<a href="register.jsp" class="btn btn-primary text-white"><i class="fa-regular fa-user"></i> Register</a>
		</div>
	</div>
</div>
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link disabled"><i class="fa-solid fa-book-open"></i> Old Books</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			<button class="btn btn-light my-2 my-sm-0 mr-1" type="submit"><i class="fa-solid fa-gear"></i>
			Setting</button>
